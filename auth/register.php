                    ...
                    <div class="divide-y divide-gray-200">
                        <form action="register.php" method="post" class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            <div class="relative mt-4">
                                <input autocomplete="off" id="username" name="username" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" placeholder="Username" />
                            ...
                            <div class="relative mt-4">
                                <button type="submit" class="w-full text-center bg-blue-600 text-white rounded-md px-auto py-2 hover:bg-transparent hover:text-blue-600 hover:border-2 hover:border-blue-600">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
