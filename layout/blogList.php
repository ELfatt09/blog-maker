            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 mb-6">
                <div class="bg-white rounded-lg border-2 p-6">
                    <a href="./index.php?type=<?= $blog['type'] ?>">
                        <h5 class="text-sm uppercase font-bold tracking-widest text-emerald-500 mb-2"><?= $blog['type'] ?></h5>
                    </a>
                    <div class="flex flex-col">
                        <?php if (!is_null($blog['header_img_path']) && !empty($blog['header_img_path'])) { ?>
                            <a href="./show.php?id=<?= $blog['id'] ?>" class="hover:text-emerald-500">
                        ...
                        <div>
                            ...
                            <div class="flex items-center mb-2">
                                ...
                                <p class="text-sm">
                                    <a href="./author.php?id=<?= $blog['author_id'] ?>" class="hover:text-emerald-500">
                            ...
                            <div class="mt-4 flex space-x-2 text-sm font-semibold">
                                <a href="./show.php?id=<?= $blog['id'] ?>" class="focus:shadow-outline hover:text-emerald-500 transition duration-150 ease-in-out">
                                    Read
                                </a>
                                <?php if (validateAuthor($blog['id'], $_SESSION['id'])) : ?>
                                    <a href="./form.php?update=<?= $blog['id'] ?>" class="focus:shadow-outline hover:text-emerald-500 transition duration-150 ease-in-out">
                                        Update
                                    </a>
